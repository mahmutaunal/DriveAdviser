...
class ProfileActivity : AppCompatActivity() {
    ...
    private fun changeLanguage() {
        ...
        val languages = arrayOf(
            resources.getString(R.string.english_text),
            resources.getString(R.string.turkish_text)
        )
    ...
    private fun setTheme() {
        ...
        androidx.appcompat.app.AlertDialog.Builder(this, R.style.CustomAlertDialog)
            ...
            .setMessage(
                resources.getString(R.string.app_theme_description_text) + "\n\n${
                    resources.getString(
                        R.string.app_theme_description_text2
                    )
                } $themeName"
            )
        ...
        call.enqueue(object : Callback<User> {
            override fun onResponse(call: Call<User>, response: Response<User>) {
                ...
                if (response.isSuccessful) {
                    ...
                    Log.e("Profile Error", response.errorBody().toString())
                }
    ...
    private fun logOutDialog() {
        AlertDialog.Builder(this, R.style.CustomAlertDialog)
            ...
            .setPositiveButton(R.string.logout_text) { dialog, _ ->
                logoutProcess()
                dialog.dismiss()
            }
        ...
        call.enqueue(object : Callback<Logout> {
            override fun onResponse(call: Call<Logout>, response: Response<Logout>) {
                ...
                if (response.isSuccessful) {
                    ...
                    val editorAuthToken: SharedPreferences.Editor =
                        sharedPreferencesAuthToken.edit()
                    ...
                    Toast.makeText(applicationContext, R.string.logged_out_text, Toast.LENGTH_SHORT)
                        .show()
                    ...
                    Log.e("Logout Error", response.errorBody().toString())
