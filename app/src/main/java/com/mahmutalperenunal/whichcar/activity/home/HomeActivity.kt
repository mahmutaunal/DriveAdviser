package com.mahmutalperenunal.whichcar.activity.home
...
import com.mahmutalperenunal.whichcar.activity.cardetail.BrandsActivity
import com.mahmutalperenunal.whichcar.activity.carsuggestion.CriteriaActivity
...
import com.mahmutalperenunal.whichcar.activity.profile.ProfileActivity
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.homeSplashLinearLayout.animate().translationY(140F).alpha(0F)
    ...
    private fun getUsername() {
        if (sharedPreferencesUsernamePassword.getString("username", null) != "") {
            binding.homeUsernameTextView.text =
                sharedPreferencesUsernamePassword.getString("username", null)
        } else {
            binding.homeUsernameTextView.text = ""
        }
    }
