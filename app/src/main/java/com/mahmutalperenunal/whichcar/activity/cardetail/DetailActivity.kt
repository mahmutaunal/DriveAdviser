        ...
        call.enqueue(object : Callback<CarDetail> {
            override fun onResponse(call: Call<CarDetail>, response: Response<CarDetail>) {
                ...
                if (response.isSuccessful) {
                    ...
                    Log.e("Car Detail Error", response.errorBody().toString())
                }
        ...
        call.enqueue(object : Callback<CarDetail> {
            override fun onResponse(call: Call<CarDetail>, response: Response<CarDetail>) {
                ...
                if (response.isSuccessful) {
                    Toast.makeText(
                        applicationContext,
                        R.string.car_added_to_favorites_text,
                        Toast.LENGTH_SHORT
                    ).show()
                } else {
                    Log.e("Car Detail Error", response.errorBody().toString())
                            ...
                            call.enqueue(object : Callback<CarDetail> {
                                override fun onResponse(
                                    ...
                                    if (response.isSuccessful) {
                                        ...
                                        Toast.makeText(
                                            applicationContext,
                                            R.string.car_recommended_text,
                                            Toast.LENGTH_SHORT
                                        ).show()

                                    } else {
                                        Log.e("Car Like Error", response.errorBody().toString())
                                    }
                            ...
                            call.enqueue(object : Callback<CarDetail> {
                                override fun onResponse(
                                    ...
                                    if (response.isSuccessful) {
                                        ...
                                        Toast.makeText(
                                            applicationContext,
                                            R.string.car_recommended_text2,
                                            Toast.LENGTH_SHORT
                                        ).show()
                            ...
                            call.enqueue(object : Callback<CarDetail> {
                                override fun onResponse(
                                    ...
                                    if (response.isSuccessful) {
                                        ...
                                        Toast.makeText(
                                            applicationContext,
                                            R.string.car_not_recommended_text,
                                            Toast.LENGTH_SHORT
                                        ).show()

                                    } else {
                                        Log.e("Car UnLike Error", response.errorBody().toString())
                                    }
                            ...
                            call.enqueue(object : Callback<CarDetail> {
                                override fun onResponse(
                                    ...
                                    if (response.isSuccessful) {
                                        ...
                                        Toast.makeText(
                                            applicationContext,
                                            R.string.car_not_recommended_text2,
                                            Toast.LENGTH_SHORT
                                        ).show()
